              ...
              {(() => {
                ...
                return (
                  <VStack align="stretch" gap={2}>
                    {/* Current Term */}
                    <Box bg="bgLightShade" p={4} rounded="lg" borderWidth="1px">
                      <HStack justify="space-between" mb={1}>
                        <Badge
                          colorScheme={
                            currentTerm.party === "Republican" ? "red" : "blue"
                          }
                        >
                          {currentTerm.party}
                        </Badge>
                        <Badge>
                          {currentTerm.type === "rep" ? "House" : "Senate"}
                        </Badge>
                      </HStack>
                    ...
                    {/* Expand toggle for historical terms */}
